...
namespace Entidades {
	class ProjetilInimigo : public ProjetilBase
	{
	private:
	...
	public:
		...
		ProjetilInimigo(std::list<Entidades::Personagens::Jogadores::Jogador*>* pJogadores, sf::Vector2f posicao = sf::Vector2f(5.f, 5.f), sf::Vector2f tamanho = sf::Vector2f(20.f, 10.f));
		~ProjetilInimigo();
